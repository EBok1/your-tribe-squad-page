// Globally declare some variables that are used in several functions
var cardsArray1 = [];
var cardsArray2 = [];
var cardsArray3 = [];
...
const pickRandomCards = async (arr1, arr2, arr3) => {
  ...
  var cardPosition1 = 360 / cardsArray1.length * findSelectedCardPosition(carousel1, selectedCard1) + 13;
  var cardPosition2 = 360 / cardsArray2.length * findSelectedCardPosition(carousel2, selectedCard2) + 13;
  var cardPosition3 = 360 / cardsArray3.length * findSelectedCardPosition(carousel3, selectedCard3) + 13;
